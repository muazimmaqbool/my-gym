import { View, Text, SafeAreaView, Platform, Pressable, ImageBackground } from "react-native";
...
const HomeScreen = () => {
  return (
    ...
    <ImageBackground source={homeBg} resizeMode="cover" style={styles.bgImage}>
      ...
      <View style={styles.mainView}>
        ...
        <Pressable style={styles.fieldContainer}>
        <MaterialCommunityIcons name="bell-alert" size={24} color="purple" />
